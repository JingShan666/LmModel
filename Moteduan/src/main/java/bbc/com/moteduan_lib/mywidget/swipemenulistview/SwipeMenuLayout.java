 ...
 * 
 */
public class SwipeMenuLayout extends android.widget.FrameLayout {
	...
	private android.view.GestureDetector.OnGestureListener mGestureListener;
	private boolean isFling;
	private int MIN_FLING = dp2px(15);
	private int MAX_VELOCITYX = -dp2px(500);
	private android.support.v4.widget.ScrollerCompat mOpenScroller;
	private android.support.v4.widget.ScrollerCompat mCloseScroller;
	private int mBaseX;
	...
	public SwipeMenuLayout(android.view.View contentView, SwipeMenuView menuView) {
		this(contentView, menuView, null, null);
	}

	public SwipeMenuLayout(android.view.View contentView, SwipeMenuView menuView,
						   android.view.animation.Interpolator closeInterpolator, android.view.animation.Interpolator openInterpolator) {
	...
	private SwipeMenuLayout(android.content.Context context, android.util.AttributeSet attrs) {
		super(context, attrs);
	}

	private SwipeMenuLayout(android.content.Context context) {
		super(context);
	}
	...
	private void init() {
		setLayoutParams(new android.widget.AbsListView.LayoutParams(android.widget.FrameLayout.LayoutParams.MATCH_PARENT,
				android.widget.FrameLayout.LayoutParams.WRAP_CONTENT));
		mGestureListener = new android.view.GestureDetector.SimpleOnGestureListener() {
			@Override
		...
		if (mCloseInterpolator != null) {
			mCloseScroller = android.support.v4.widget.ScrollerCompat.create(getContext(),
					mCloseInterpolator);
		} else {
			mCloseScroller = android.support.v4.widget.ScrollerCompat.create(getContext());
		}
		if (mOpenInterpolator != null) {
			mOpenScroller = android.support.v4.widget.ScrollerCompat.create(getContext(),
					mOpenInterpolator);
		} else {
			mOpenScroller = android.support.v4.widget.ScrollerCompat.create(getContext());
		}
		...
		mMenuView.setLayoutParams(new android.widget.FrameLayout.LayoutParams(android.widget.FrameLayout.LayoutParams.WRAP_CONTENT,
				android.widget.FrameLayout.LayoutParams.WRAP_CONTENT));
	...
	public boolean onSwipe(android.view.MotionEvent event) {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mMenuView.measure(android.view.View.MeasureSpec.makeMeasureSpec(0,
				android.view.View.MeasureSpec.UNSPECIFIED), android.view.View.MeasureSpec.makeMeasureSpec(
				getMeasuredHeight(), android.view.View.MeasureSpec.EXACTLY));
	}
	...
	public void setMenuHeight(int measuredHeight) {
		android.util.Log.i("byz", "pos = " + position + ", height = " + measuredHeight);
		android.widget.FrameLayout.LayoutParams params = (android.widget.FrameLayout.LayoutParams) mMenuView.getLayoutParams();
