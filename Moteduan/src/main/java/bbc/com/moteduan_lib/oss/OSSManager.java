package bbc.com.moteduan_lib.oss;
...
import bbc.com.moteduan_lib.tools.Regular;
...
public class OSSManager {
    ...
    private static void init() {
        ...
        ossClient = new OSSClient(App.getApp(), endpoint, credentialProvider, conf);
...
//            }
        ...
        switch (type) {
            case IMAGE_TYPE:
                fileName = (imagePath + "lm_img_" + System.currentTimeMillis() + ".jpg");
                break;
            case VIDEO_THUMI_TYPE:
                fileName = (videoThumlPath + "lm_img_" + System.currentTimeMillis() + ".jpg");
                break;
            case VIDEO_TYPE:
                fileName = (videoPath + "lm_video_" + System.currentTimeMillis() + ".mp4");
                break;
        }
...
//        }
        ...
        Loger.log(TAG, "ETag = " + putResult.getETag() + " RequestId = " + putResult.getRequestId());
