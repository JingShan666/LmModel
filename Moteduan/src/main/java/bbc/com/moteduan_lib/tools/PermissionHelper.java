...
public class PermissionHelper {
    ...
    private void initMap() {
        if (null == mAllPermissonMap) {
            ...
            mAllPermissonMap.put(Manifest.permission.ACCESS_COARSE_LOCATION, "定位");
            mAllPermissonMap.put(Manifest.permission.ACCESS_FINE_LOCATION, "ACCESS_FINE_LOCATION");
            mAllPermissonMap.put(Manifest.permission.CAMERA,"调用摄像头");
            mAllPermissonMap.put(Manifest.permission.WRITE_EXTERNAL_STORAGE,"访问本地");
