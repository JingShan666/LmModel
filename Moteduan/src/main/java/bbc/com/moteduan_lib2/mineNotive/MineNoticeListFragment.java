...
//        }
    ...
    private void initData(final int type) {
        ...
        Req.post(Url.Invite.mineNoticeList, map, new Req.ReqCallback() {
            @Override
    ...
    private class RvAdapter extends RecyclerSwipeAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof EmptyDataViewHolder) {
                ...
                Loger.log(TAG, "trader_state : " + trader_state);
                switch (trader_state) {
                    case 1:
                ...
                h.swipeLayout.addSwipeListener(new SwipeLayout.SwipeListener() {
                    ...
                    public void onStartOpen(SwipeLayout layout) {
                        ...
                        Loger.log(TAG,"onStartOpen");
                    }

                    @Override
                    public void onOpen(SwipeLayout layout) {
                        Loger.log(TAG,"onOpen");
                    }

                    @Override
                    public void onStartClose(SwipeLayout layout) {
                        Loger.log(TAG,"onStartClose");
                    }

                    @Override
                    public void onClose(SwipeLayout layout) {
                        layout.setClickable(true);
                        Loger.log(TAG,"onClose");
                    }

                    @Override
                    public void onUpdate(SwipeLayout layout, int leftOffset, int topOffset) {
                        Loger.log(TAG,"onUpdate");
                    }

                    @Override
                    public void onHandRelease(SwipeLayout layout, float xvel, float yvel) {
                        Loger.log(TAG,"onHandRelease");
                    }
                });
                ...
                h.delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Req.post(Url.Invite.deleteNotice, map, new Req.ReqCallback() {
                            @Override
                            public void success(String result) {
                                try {
                ...
                h.swipeLayout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(getActivity(), NoticeDetailsActivity.class).putExtra("orderId", bean.getTrader_order_id()));
                    }
                });
            }
        }
