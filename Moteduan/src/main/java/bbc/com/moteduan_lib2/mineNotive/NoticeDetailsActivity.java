...
public class NoticeDetailsActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        Req.post(Url.Invite.mineNoticeDetails, map, new Req.ReqCallback() {
            ...
            public void success(String result) {
                ...
                if (!"200".equals(bean.getCode())) {
                    ToastUtil.show(NoticeDetailsActivity.this, bean.getTips());
                    return;
                }
                ...
                remark.setText(bean.getTraderOrder().getRemarks());
                ...
                switch (traderState) {
                    case 1:
                        ...
                        cancelOrder.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                DialogUtils.showTextDialog(NoticeDetailsActivity.this, "确定取消报名吗？", new Handler.Callback() {
                                    @Override
                                    public boolean handleMessage(Message msg) {
                                        ...
                                        if (msg.what == 1) {
                                            ...
                                            map.put("traderorder_id", trader_order_id);
                                            Req.post(Url.Invite.cancelNotice, map, new Req.ReqCallback() {
                                                @Override
                                                public void success(String result) {
                                                    try {
                                                ...
                                                public void failed(String msg) {
                                                    ToastUtil.show(NoticeDetailsActivity.this, getResources().getString(R.string.error_network_block));
                                                    Loger.log(TAG, msg);
                    ...
                    case 2:
                        ...
                        tips.setText(getResources().getText(R.string.notice_cancel_rule));
                        bt.setEnabled(true);
                        bt.setText(String.format("开始%1$s", getResources().getString(R.string.deal_appellation)));
                        bt.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                DialogUtils.inputInviteCodeDialog(NoticeDetailsActivity.this, "", new Handler.Callback() {
                                    @Override
                                    public boolean handleMessage(Message msg) {
                                        if (null == msg) return false;
                                        ...
                                        Req.post(Url.Invite.startNotice, map, new Req.ReqCallback() {
                                            @Override
                                            public void success(String result) {
                                                try {
                                                    JSONObject jsonObject = new JSONObject(result);
                                            ...
                                            @Override
                                            public void failed(String msg) {
                                                toast.showText(getResources().getString(R.string.error_network_block));
                                                Loger.log(TAG, msg);
                                            }
                        ...
                        cancelOrder.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                DialogUtils.commonAlert(NoticeDetailsActivity.this, "", "请您认真阅读下方的取消规则后，再确认取消。"
                                        , String.format("确定取消%1$s", getResources().getString(R.string.deal_appellation)), "", "好的", new Handler.Callback() {
                                            @Override
                                            public boolean handleMessage(Message msg) {
                                                if (null == msg) return false;
                                                if (msg.what == 0) {
                                                    ...
                                                    Map<String, Object> map = new HashMap<String, Object>();
                                                    map.put("traderorder_id", trader_order_id);
                                                    Req.post(Url.Invite.cancelNoticeOrder, map, new Req.ReqCallback() {
                                                        @Override
                                                        public void success(String result) {
                                                            try {
                                                                JSONObject jsonObject = new JSONObject(result);
                    ...
                    case 3:
                        ...
                        // 进行中
                        findViewById(R.id.activity_notice_details_conversation_ll).setVisibility(View.VISIBLE);
                        Req.post(Url.getSystemTime, null, new Req.ReqCallback() {
                            @Override
                            public void success(String result) {
                                JSONObject jsonObject = null;
            ...
            @Override
            public void failed(String msg) {
                ToastUtil.show(NoticeDetailsActivity.this, msg);
            }
    ...
    public void initEvents() {
            ...
            public void onClick(View v) {
                if (null != bean) {
                    if (null != RongIM.getInstance()) {
                        ...
                        RongIM.getInstance().startConversation(NoticeDetailsActivity.this,
        ...
        callPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != bean) {
                    DialogUtils.callPhoneAlert(NoticeDetailsActivity.this, bean.getTraderOrder().getU_mobile());
                }
            }
        });
    }
    ...
    private void countDownTime(String surrectDate, String endDate, final TextView showView) {
        LogDebug.log(NoticeDetailsActivity.class.getSimpleName(), "surrectDate=" + surrectDate + " endDate=" + endDate);
        ...
        LogDebug.log(NoticeDetailsActivity.class.getSimpleName(), end.getTimeInMillis() + "-" + currect.getTimeInMillis());
        countDownTimer = new CountDownTimer(end.getTimeInMillis() - currect.getTimeInMillis(), 1000) {
            @SuppressLint("DefaultLocale")
            @Override
            public void onTick(long millisUntilFinished) {
                LogDebug.log(NoticeDetailsActivity.class.getSimpleName(), millisUntilFinished + "");
