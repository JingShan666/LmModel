...
public class InviteDetailsDidNotSignUpActivity extends BaseActivity {

    public static String TAG = "InviteDetailsDidNotSignUpActivity";
    ...
    public void initView() {
        dialogDataReq = new DialogUtils.DataReqDialog(this);
    ...
    public void initData() {
        ...
        Req.post(Url.inviteOrderDetails, map, new Req.ReqCallback() {
            ...
            public void success(String result) {
                ...
                if (!"200".equals(bean.getCode())) {
                    ToastUtil.show(InviteDetailsDidNotSignUpActivity.this, bean.getTips());
                    return;
                }
...
//                }
            ...
            public void failed(String msg) {
                ToastUtil.show(InviteDetailsDidNotSignUpActivity.this, msg);
            }
    ...
    public void initEvents() {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final LoginBean loginBean = SpDataCache.getSelfInfo(InviteDetailsDidNotSignUpActivity.this);
                if (null == loginBean || TextUtils.isEmpty(loginBean.getData().getM_id())) {
                    ToastUtil.show(InviteDetailsDidNotSignUpActivity.this, "您还未登录，请先登录");
                    Intent intent = new Intent();
                    intent.setAction("bbc.com.moteduan_lib2.login.LoginActivity");
                    InviteDetailsDidNotSignUpActivity.this.startActivity(intent);
                    return;
                }
                new AlertDialog.Builder(InviteDetailsDidNotSignUpActivity.this)
                        .setMessage("确定要报名吗？")
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Req.post(Url.applyInviteOrder, map, new Req.ReqCallback() {
                                    @Override
                                    public void success(String result) {
                                        try {
                                            ...
                                            ToastUtils.getInstance(InviteDetailsDidNotSignUpActivity.this).showText(tips);
                                            if (!"200".equals(code)) {
                                                return;
                                            }
                                            setResult(RESULT_OK);
                                    ...
                                    @Override
                                    public void failed(String msg) {
                                        ToastUtils.getInstance(InviteDetailsDidNotSignUpActivity.this).showText(msg);
                                    }
                                    @Override
                                    public void completed() {
...
//                报名之前调接口检查是否认证过
//                Map<String, Object> map = new HashMap<>();
//                map.put("member_id", SpDataCache.getSelfInfo(InviteDetailsDidNotSignUpActivity.this).getData().getM_id());
...
//                            String tips = jsonObject.getString("tips");
//                            if (!"200".equals(code)) {
//                                startActivity(new Intent(InviteDetailsDidNotSignUpActivity.this, AuthenticationActivity.class));
//                                ToastUtils.getInstance(InviteDetailsDidNotSignUpActivity.this).showText(tips);
//                                return;
//                            }
//                        } catch (JSONException e) {
//                            e.printStackTrace();
//                            ToastUtils.getInstance(InviteDetailsDidNotSignUpActivity.this).showText(e.getMessage());
//                        }
//                    }
//                    @Override
//                    public void failed(String msg) {
