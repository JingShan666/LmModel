...
public class AppointmentOrderListFragment extends BaseFragment {
    public static final String TAG = "AppointmentOrderListFragment";
    ...
    private void initData(final int type) {
        ...
        Req.post(Url.appointmentOrderList, map, new Req.ReqCallback() {
            @Override
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof EmptyDataViewHolder) {
                ...
                h.swipeLayout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(getActivity(), AppointmentOrderDetailsActivity.class).putExtra("orderId", bean.getTrader_order_id()));
                    }
                });
            }
        }
