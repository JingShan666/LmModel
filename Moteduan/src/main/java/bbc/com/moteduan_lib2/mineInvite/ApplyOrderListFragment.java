...
public class ApplyOrderListFragment extends BaseFragment {
    private static String TAG = "ApplyOrderListFragment";
    ...
    private void initData(final int type) {
        ...
        Req.post(Url.mineApplyList, map, new Req.ReqCallback() {
            @Override
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if(holder instanceof EmptyDataViewHolder){
                ...
                h.swipeLayout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(getActivity(), ApplyOrderDetailsActivity.class).putExtra("orderId", bean.getTrader_order_id()));
                    }
                });
            }
        }
