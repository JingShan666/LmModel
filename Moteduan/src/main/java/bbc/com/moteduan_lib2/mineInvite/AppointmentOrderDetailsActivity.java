...
public class AppointmentOrderDetailsActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        Req.post(Url.appointmentInviteOrderDetails, map, new Req.ReqCallback() {
            @SuppressLint("SetTextI18n")
            @Override
            public void success(String result) {
                bean = new Gson().fromJson(result, MineOrderDetailsBean.class);
                if (!"200".equals(bean.getCode())) {
                    ToastUtil.show(AppointmentOrderDetailsActivity.this, bean.getTips());
                    return;
                }
                ...
                switch (traderState) {
                    case 1:
                        ...
                        bt.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                map.put("traderorder_id",trader_order_id);
                                Req.post(Url.agreeUserApply, map, new Req.ReqCallback() {
                                    @Override
                                    public void success(String result) {
                                        try {
                                            ...
                                            decline.setOnClickListener(null);
                                            conversationLL.setVisibility(View.GONE);
                                            bt.setEnabled(false);
                        ...
                        decline.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Map<String,Object> map = new HashMap<String, Object>();
                                map.put("traderorder_id",trader_order_id);
                                Req.post(Url.declineUserAapply, map, new Req.ReqCallback() {
                                    @Override
                                    public void success(String result) {
                                        try {
                                            JSONObject jsonObject = new JSONObject(result);
                    ...
                    case 2:
                        ...
                        bt.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                DialogUtils.inputInviteCodeDialog(AppointmentOrderDetailsActivity.this,"", new Handler.Callback() {
                                    @Override
                        ...
                        cancelOrder.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                DialogUtils.showTextDialog(AppointmentOrderDetailsActivity.this, String.format("确定要取消%1$s吗？", getResources().getString(R.string.deal_appellation)), new Handler.Callback() {
                                    @Override
                                    public boolean handleMessage(Message msg) {
                                        if (null == msg) return false;
                                        if (msg.what == 1) {
            ...
            @Override
            public void failed(String msg) {
                ToastUtil.show(AppointmentOrderDetailsActivity.this, msg);
            }
    ...
    public void initEvents() {
            ...
            public void onClick(View v) {
                if (null != bean) {
                    if (null != RongIM.getInstance()) {
                        ...
                        RongIM.getInstance().startConversation(AppointmentOrderDetailsActivity.this,
        ...
        callPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != bean) {
                    DialogUtils.callPhoneAlert(AppointmentOrderDetailsActivity.this, bean.getTraderOrder().getU_mobile());
                }
            }
        });
    }
