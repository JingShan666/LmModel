...
public class MomentsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(userId)) {
            ToastUtil.show(MomentsActivity.this, "数据开小差了哦，暂时无法查看动态。");
            finish();
            return;
        }
        ...
        mSpringView.setHeader(new DefaultHeader(MomentsActivity.this));
        mSpringView.setFooter(new DefaultFooter(MomentsActivity.this));
        mSpringView.setListener(onFreshListener);
        recycleView = (BaseRecycleView) findViewById(R.id.fragment_moments_rv);
        final LinearLayoutManager manager = new LinearLayoutManager(MomentsActivity.this);
    ...
    private void initData(final int type) {
        LoginBean loginBean = SPUtils.getSelfInfo(MomentsActivity.this);
        ...
        ReqUrl.post(Url.peekMomentList, map, new ReqCallback.Callback1<String>() {
...
//                        ToastUtil.show(getContext(), jsonObject.getString("tips"));
            ...
            public void failed(String msg) {
                //ToastUtil.show(MomentsActivity.this, "获取数据失败" + msg);
                ToastUtil.show(MomentsActivity.this,"网络连接不可用，请稍后重试");
            }
                ...
                if (!TextUtils.isEmpty(itemBean.getPhotos())) {
                    ...
                    if (photoList.getList() != null) {
                        ...
                        h.mPictureSingle.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent = new Intent(MomentsActivity.this, WatchPictureActivity.class);
...
//                        LoginBean loginBean = SPUtils.getSelfInfo(MomentsActivity.this);
//                        if (null == loginBean) {
//                            ToastUtil.show(MomentsActivity.this, "您还未登录，请先登录");
//                            Intent intent = new Intent();
//                            intent.setAction("bbc.com.moteduan_lib2.login.LoginActivity");
...
//                                    String code = jsonObject.getString("code");
//                                    if (!TextUtils.equals("200", code)) {
//                                        ToastUtil.show(MomentsActivity.this, jsonObject.getString("tips"));
//                                        return;
//                                    }
...
//                            @Override
//                            public void failed(String msg) {
//                                ToastUtil.show(MomentsActivity.this, msg);
//                            }
//                        });
                    }
                });
                ...
                h.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivityForResult(new Intent(MomentsActivity.this, MomentDetailsActivity.class)
                ...
                h.delete.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DialogUtils.Factory.commonAlert(MomentsActivity.this, "", "确定要删除这条动态吗？", "确定", "", "取消", new Handler.Callback() {
                            @Override
                            public boolean handleMessage(Message msg) {
                                ...
                                if (msg.what == 0) {
                                    Map<String, Object> map = new HashMap<String, Object>();
                                    map.put("content_id", itemBean.getContent_id());
                                    ReqUrl.post(Url.deleteMoment, map, new ReqCallback.Callback<String>() {
                                        @Override
                                        public void success(String result) {
                                            try {
                                                JSONObject jsonObject = new JSONObject(result);
                                                String code = jsonObject.getString("code");
                                                String tips = jsonObject.getString("tips");
                                                ToastUtil.show(MomentsActivity.this, tips);
                                                if (!"200".equals(code)) {
                                                    return;
                                                }
                ...
                h.mControlContainer.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (TextUtils.isEmpty(finalVideoUrl1)) {
                            ToastUtil.show(MomentsActivity.this, "视频地址未找到,播放失败");
                            return;
                        }
...
//                        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Loger.log(TAG, "requestCode = " + requestCode + " resultCode = " + resultCode + " data is null = " + (data == null));
